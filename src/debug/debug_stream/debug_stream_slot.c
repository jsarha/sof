...
int debug_stream_slot_send_record(struct debug_stream_record *rec)
{
	...
	rec->size = record_size + 1; /* +1 for size at the end of record */
...
static int debug_stream_slot_init(void)
{
	...
	LOG_INF("debug_stream_record id %u serial %u size %u data %u, sizeof %u",
		offsetof(struct debug_stream_record, id),
		offsetof(struct debug_stream_record, serial),
		offsetof(struct debug_stream_record, size),
		offsetof(struct debug_stream_record, data),
		sizeof(struct debug_stream_record));

	LOG_INF("debug_stream_slot_hdr hdr %u total_size %u num_sections %u section_desc0 %u  section_desc1 %u, sizeof %u",
		offsetof(struct debug_stream_slot_hdr, hdr),
		offsetof(struct debug_stream_slot_hdr, total_size),
		offsetof(struct debug_stream_slot_hdr, num_sections),
		offsetof(struct debug_stream_slot_hdr, section_desc[0]),
		offsetof(struct debug_stream_slot_hdr, section_desc[1]),
		sizeof(struct debug_stream_slot_hdr));
